...
const Value = () => {
    ...
    return(
        <div className="mb-[4rem] mt-[5rem]">
            <h1 className="text-textColor text-[2rem] py-[2rem] pb-[3rem] font-bold w-[100%] block text-center">The value that holds us true and to account</h1>
            ...
            <div className="grid gap-[10rem] grid-cols-3 items-center">
                ...
                <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]">
                    ...
                    <p className="text-[13px] text-textColor opacity-[0.7] py-[1rem] font-semibold">
                        We work on the basis of creating trust which can be nurtured through authenticcity and transparency.
                    </p>
                </div>
            </div>
